      ...
      <Row className = "mt-4">
        ...
        <Col className = "mt-4">
          <Card style = {{ maxWidth: '360px' }} className = "mx-auto p-4">
            ...
            <Button style = {{textDecoration: 'none'}} variant = "link" className = "mt-1" onClick = {openChangePasswordModal} >Change password</Button>
            <Button style = {{textDecoration: 'none'}} variant = "link" className = "mt-3 text-danger" onClick = {openDeleteModal}>Delete account</Button>
          </Card>
        </Col>
      </Row>
    </Container>
